...
public class CreateRequestTest {
    ...
    public void UserRequestFailed() {
        User user = userDAO.selectPerson("sagonzalezn");
    ...
    public void UserRequestSuccess() {
        ...
        User user2 = userDAO.selectPerson("avargasr");
    ...
    public void AdminRequestFailed(){
        ...
        try {
            ...
            User agent = userDAO.selectAgent("avargasr");
        ...
        try {
            ...
            Set<User> agents = Set.of(userDAO.selectAgent("avargasr"), userDAO.selectAgent("rcalvom"));
